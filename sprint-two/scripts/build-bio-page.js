...
function createCommentElement(comment) {
  ...
  commentsComment.className = "comments__comment";
  ...
  commentPhoto.className = "comments__comment-photo";
  ...
  commentFilledForm.className = "comments__comment-filledForm";
  ...
  commentsCommentTitle.className = "comments__comment-title";
  ...
  commentsCommentAuthor.className = "comments__comment-author";
  ...
  commentsCommentDate.className = "comments__comment-date";
  commentsCommentDate.innerText = comment.date;
  ...
  commentsCommentText.className = "comments__comment-text";
